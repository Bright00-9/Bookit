...
class _WorkerHomeScreenState extends State<WorkerHomeScreen>
  ...
  // ── Fix: scaffold key to control drawer ──────────────────────
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // ── Fix: use scaffoldKey so menu button opens drawer ──
      key: _scaffoldKey,
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _drawerItem(
                      Icons.photo_library_outlined, 'My Posts',
                      () {
                    Navigator.pop(context);
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
                'Check back soon or wait for new alerts',
                style: TextStyle(
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            const Text(
                'Tap Share Work to post your first photo!',
                style: TextStyle(
                    color: Color(0xFF888888), fontSize: 13)),
          ],
        ),
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              delegate: SliverChildBuilderDelegate(
                (context, i) =>
                    _buildMyPostThumbnail(_myPosts[i]),
