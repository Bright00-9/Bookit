...
class _IdentityVerificationScreenState
  ...
  Widget _buildStatusBanner() {
    ...
    return _statusCard(
      color: color,
      title: '${_status.emoji} ${_status.label}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          _infoRow(
              '1️⃣', 'Submit your national ID + selfie'),
          _infoRow(
              '2️⃣', 'Upload a short work video (max 60s)'),
          _infoRow(
              '✅', 'Admin reviews and approves you'),
          _infoRow(
              '💼', 'Start posting and accepting jobs'),
        ],
      ),
    );
  }
