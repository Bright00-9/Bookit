...
class _LeaderboardScreenState extends State<LeaderboardScreen>
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _headerMedalStat('🥇', goldCount, 'Gold'),
                  const SizedBox(width: 12),
                  _headerMedalStat('🥈', silverCount, 'Silver'),
                  const SizedBox(width: 12),
                  _headerMedalStat('🥉', bronzeCount, 'Bronze'),
                ],
              ),
            ],
          ),
  ...
  Widget _headerMedalStat(String emoji, int count, String label) {
    return Container(
      padding:
