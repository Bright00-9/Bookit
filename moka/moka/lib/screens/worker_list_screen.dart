      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _legendRow(WorkerMedal.gold, '4.4 and above', 'Five-star'),
            const SizedBox(height: 12),
            _legendRow(WorkerMedal.silver, '2.6 — 4.3', 'Three-star'),
            const SizedBox(height: 12),
            _legendRow(WorkerMedal.bronze, '2.5 and below', 'One-star'),
